...
$routes->get('dashboard/clientes-ir', 'Dashboard::clientesIR');
$routes->get('dashboard/clientes-inativos', 'Dashboard::clientesInativos');
$routes->get('dashboard/mensalistas', 'Dashboard::mensalistas');
$routes->get('dashboard/aniversariantes', 'Dashboard::aniversariantes');
$routes->get('dashboard/certificados-vencendo', 'Dashboard::certificadosVencendo');
