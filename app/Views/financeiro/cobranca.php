      ...
      <div class="col-md-12 col-xs-12">
        <div class="card">
          <div class="card-header bg-primary">
            <h5 class="text-center">COBRANÇAS</h5>
          </div>
          <div class="card-body">
            <?php if (hasPermission('criarReceber')) : ?>
              <button class="btn btn-lg btn-warning mb-2" data-toggle="modal" data-target="#addModal"><i class="fas fa-plus-square"></i> EXECUTAR TODAS</button>
            <?php endif; ?>
