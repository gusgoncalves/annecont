      ...
      <div class="row">
        <div class="col-md-12 col-xs-12">
          ...
          <?php if(in_array('criarCertidao', $user_permission)): ?>
            <button class="btn btn-lg btn-warning mb-2" data-toggle="modal" data-target="#addModalCertidao"><i class="fas fa-plus-square"></i> NOVA CERTIDÃO</button>
            <br />
          <?php endif; ?>
          <div class="card">
            ...
            <table id="manageTable" class="table table-bordered table-striped table-hover">
              <thead>
                <tr>
                  ...
                  <th>DESCRIÇÃO</th>
                  <th>EXPIRA</th>
                  <?php if(in_array('modificarCertidao', $user_permission) || in_array('apagarCertidao', $user_permission)): ?>
...
<script type="text/javascript">
  ...
  manageTable = $('#manageTable').DataTable({
    'ajax': base_url + 'certidoes/recebeDadosCertidao',
    'responsive': true,
