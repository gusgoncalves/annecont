...
<div class="modal fade"  role="dialog" id="addModal">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form role="form" action="<?php echo base_url('certidoes/createTipo') ?>" class="requires-validation" method="post" id="createForm" novalidate>
...
<div class="modal fade" tabindex="-1" role="dialog" id="editModal">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form role="form" action="<?php echo base_url('certidoes/updateTipo') ?>" method="post" id="updateForm">
        <div class="modal-body">
          <div id="messages"></div>
          <div class="form-group">
...
<div class="modal fade" tabindex="-1" role="dialog" id="removeModal">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form role="form" action="<?php echo base_url('certidoes/removeTipo') ?>" method="post" id="removeForm">
        <div class="modal-body">
...
$(function () {
  ...
  manageTable = $('#manageTable').DataTable({
    'ajax': base_url + 'certidoes/recebeDadosTipoCertidao',
    'responsive': true,
...
{ 
  $.ajax({
    url: base_url + 'certidoes/EncontraTipoCertidaoPorID/'+id,
    type: 'post',
    dataType: 'json',
    success:function(response) {
