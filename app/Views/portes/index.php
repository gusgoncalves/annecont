    ...
    <section class="content">
      ...
      <div class="row">
        <div class="col-md-12 col-xs-12">
          <div id="messages"></div>
          <?php if(in_array('modificarEmpresa', $user_permission)): ?>
            <button class="btn btn-lg btn-warning mb-2" data-toggle="modal" data-target="#addModal"><i class="fas fa-plus-square"></i> NOVO PORTE</button>
            <br />
          <?php endif; ?>
          <div class="card">
...
<?php if(in_array('modificarEmpresa', $user_permission)): ?>
<!-- CRIANDO MODAL ADICIONAR NOVO PORTE -->
<div class="modal fade" tabindex="-1" role="dialog" id="addModal">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form role="form" action="<?php echo base_url('portes/create') ?>" class="requires-validation" method="post" id="createForm" novalidate>
...
<div class="modal fade" tabindex="-1" role="dialog" id="editModal">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form role="form" action="<?php echo base_url('portes/update') ?>" method="post" id="updateForm">
        <div class="modal-body">
          <div id="messages"></div>
          <div class="form-group">
...
<div class="modal fade" tabindex="-1" role="dialog" id="removeModal">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form role="form" action="<?php echo base_url('portes/remove') ?>" method="post" id="removeForm">
        <div class="modal-body">
...
$(function () {
    ...
    manageTable = $('#manageTable').DataTable({
      'ajax': base_url + 'portes/recebeDadosPorte',
      'responsive': true,
...
{ 
  $.ajax({
    url: base_url + 'portes/EncontraPortePorID/'+id,
    type: 'post',
    dataType: 'json',
    success:function(response) {
