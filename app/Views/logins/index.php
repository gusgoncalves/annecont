      ...
      <div class="row">
        <div class="col-md-12 col-xs-12">
          ...
          <?php if(in_array('criarLogin', $user_permission)): ?>
            <button class="btn btn-lg btn-warning mb-2" data-toggle="modal" data-target="#addModalLogin"><i class="fas fa-plus-square"></i> NOVO LOGIN</button>
            <br />
          <?php endif; ?>
          <div class="card">
            ...
            <div class="card-body">
              <table id="manageTable" class="table table-bordered table-striped table-hover">
                ...
                <tr>
                  ...
                  <th>USUÁRIO</th>
                  <th>SENHA</th>
                  <?php if(in_array('modificarLogin', $user_permission) || in_array('apagarLogin', $user_permission)): ?>
...
$(function() {
  ...
  manageTable = $('#manageTable').DataTable({
    'ajax': base_url + 'logins/recebeDadosLogins',
    'responsive': true,
