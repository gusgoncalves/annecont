        ...
        <div class="col-md-12 col-xs-12">
          ...
          <div class="card">
            <div class="card-header bg-primary">
              <h5 class="text-center">LISTA DE MESES</h5>
            </div>
            <!-- /.box-header -->
            <div class="card-body">
...
<div class="modal fade" tabindex="-1" role="dialog" id="addModal">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form role="form" action="<?php echo base_url('faturamento/createMes') ?>" class="requires-validation" method="post" id="createForm" novalidate>
...
<div class="modal fade" tabindex="-1" role="dialog" id="editModal">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header bg-primary">
        <h4 class="modal-title text-center">ALTERAR MÊS</h4>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
      </div>
      <form role="form" action="<?php echo base_url('faturamento/updateMes') ?>" method="post" id="updateForm">
        <div class="modal-body">
          <div class="form-group">
            <label for="edit_mes">MÊS</label>
            <input type="text" class="form-control" id="edit_mes" name="edit_mes" required>
            <div class="invalid-feedback">Preenchimento Obrigatório!</div>
          </div>          
        </div>
        <div class="modal-footer">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header bg-danger">
        <h4 class="modal-title text-center">APAGAR MÊS</h4>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
      </div>
      <form role="form" action="<?php echo base_url('faturamento/removeMes') ?>" method="post" id="removeForm">
        <div class="modal-body">
          <p>Tem certeza que deseja remover o Mês?</p>
        </div>
        <div class="modal-footer">
...
{ 
  $.ajax({
    url: base_url + 'faturamento/recebeDadosMeses/'+id,
    type: 'post',
    dataType: 'json',
    success:function(response) {
      $("#edit_mes").val(response.nome);
