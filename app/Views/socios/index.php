    ...
    <div class="row">
      <div class="col-md-12 col-xs-12">
        ...
        <?php if(in_array('criarCliente', $user_permission)): ?>
          <a href="<?php echo base_url('socios/create') ?>" class="btn btn-lg btn-warning mb-2"><i class="fas fa-plus-square"></i> NOVO SÓCIO</a>
        <?php endif; ?>
        <br />
        <div class="card">
          ...
          <div class="card-body">
            <table id="manageTable" class="table table-bordered table-striped table-hover">
              ...
              <tr>
                ...
                <th>NOME</th>
                <th>WHATSAPP</th>
                <?php if(in_array('modificarCliente', $user_permission) || in_array('apagarCliente', $user_permission)): ?>
...
<div class="modal fade" tabindex="-1" role="dialog" id="removeModal">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form role="form" action="<?php echo base_url('socios/remove') ?>" method="post" id="removeForm">
...
$(function () {
  ...
  manageTable = $('#manageTable').DataTable({
    'ajax': base_url + 'socios/buscarDadosSocios',//MONTA A DATA TABLE
    'responsive': true,
