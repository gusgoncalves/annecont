                      ...
                      <div class="card">
                        ...
                        <div class="card-body">
                          ...
                          <table class="table table-striped table-bordered">
                            ...
                            <tr>
                              <th>TÍTULO:</th>
                              <td><?= strtoupper($z['titulo']); ?></td>
                            </tr>
                            <tr>
                              <th>WHATSAPP:</th>
                              <td><?= strtoupper($z['whatsapp']); ?></td>
                            </tr>
                            <tr>
                              <th>ENDEREÇO:</th>
                              <td><?= strtoupper($z['endereco']); ?></td>
                            </tr>
                            <tr>
                              <th>RECIBO:</th>
                              <td><?= $z['recibo']; ?></td>
                            ...
                            <tr>
                              <th>NASCIMENTO:</th>
                              <td><?= date('d/m/Y', strtotime($z['nascimento'])); ?></td>
                            </tr>
                            <tr>
                              <th>NOME DA MÃE:</th>
                              <td><?= $z['nome_mae']; ?></td>
                        ...
                        <div class="card-body">
                          <table class="table table-striped table-bordered">
                              ...
                              <?php foreach($certificado_data as $k => $v ) : ?>
                                <tr>                  
                                  <td class="width:10%"><?= strtoupper($v['descricao']); ?></td>
                                  <td><?= date('d/m/Y', strtotime($v['dt_validade'])); ?></td>
                                  <td class="width:10%"><?= $v['senha']; ?></td>
                                </tr>
                                </a>
                              <?php endforeach; ?>
                            </table>
                        ...
                        <div class="card-body">
                          <table class="table table-striped table-bordered">
                            ...
                            <?php foreach($certidao_data as $k => $v ) : ?>
                              $dt_expira = date('d/m/Y',strtotime($v['dt_expira']));
                              ?>
                              <tr>
                                <?php foreach($tipo_certidao as $tipo) : ?>                 
                                  <?php if($tipo['id'] === $v['id_tipo_certidao']) : ?>
                                    <td><?= strtoupper($tipo['nome']); ?></td>
                                  <?php endif; ?>
                                <?php endforeach; ?>
                                <td><?= $dt_expira?></td>
                              </tr>
                          ...
                          <table class="table table-striped table-bordered">
                            ...
                            <?php endforeach; ?>
                              <tr colspan="1">
                                <td></td>
                                <td></td>
                                <?php if($total_faturamento['total'] !== NULL) : ?>
                                  <td class="bg-warning"><b><h3>R$ <?=number_format($total_faturamento['total'],2,',','.');?></h3></b></td>
                                <?php endif; ?>
                              </tr>
                          </table>
                        </div>
