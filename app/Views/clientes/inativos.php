  ...
  <section class="content">
    ...
    <div class="row">
      <div class="col-md-12 col-xs-12">
        <div id="messages"></div>
        <?php if(in_array('criarCliente', $user_permission)): ?>
          <a href="<?php echo base_url('clientes/create') ?>" class="btn btn-lg btn-warning mb-2"><i class="fas fa-plus-square"></i> NOVO CLIENTE</a>
        <?php endif; ?>
        <br />
        <div class="card">
          <div class="card-header bg-primary">
            <h5 class="text-center">LISTA DE CLIENTES INATIVOS</h5>
          </div>
          <!-- /.card-header -->
          <div class="card-body">
            <div class="row">
              <!-- Botão que redireciona para um link específico -->
              <a href="<?php echo base_url('clientes/') ?>" class="btn btn-lg btn-success mb-2"><i class="fas fa-plus-square"></i> VER ATIVOS</a>
            </div>
            <table id="manageTable" class="table table-bordered table-striped table-hover">
              ...
              <tr>
                ...
                <th>CNPJ / CPF</th>
                <th>WHATSAPP</th>
                <?php if(in_array('verCliente', $user_permission) || in_array('modificarCliente', $user_permission) || in_array('apagarCliente', $user_permission)): ?>
...
<?php if(in_array('apagarCliente', $user_permission)): ?>
<!-- remove brand modal -->
...
<script type="text/javascript">
  var manageTable;//DADOS QUE SÃO MOSTRADOS NA TABELA DATATABLE
  ...
  $(function () {
    ...
    manageTable = $("#manageTable").DataTable({
      'ajax': base_url + "clientes/buscarDadosClienteInativo",
      'responsive': true,
