    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header bg-primary">
          <h5 class="modal-title text-center">NOVO COBRANÇA</h5>
        ...
        <div class="modal-content">
          ...
          <form role="form" action="<?php echo base_url('pagar/estornar') ?>" method="post" id="estornarForm">
            <div class="modal-body">
              ...
              <p><b>ESSA OPÇÃO FAZ COM QUE A CONTA RETORNE PARA O STATUS <span class="badge badge-danger">EM ABERTO?</b></p>
              <p><b> ISSO PODE GERAR IMPACTO NO FLUXO DE CAIXA.</b> </p></br>
