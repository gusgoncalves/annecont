      ...
      <div class="row">
        <div class="col-md-12 col-xs-12">
          ...
          <?php if(in_array('modificarEmpresa', $user_permission)): ?>
            <button class="btn btn-lg btn-warning mb-2" data-toggle="modal" data-target="#addModal"><i class="fas fa-plus-square"></i> NOVO CAIXA</button>
            <br />
          <?php endif; ?>
          <div class="card">
            <div class="card-header bg-primary">
              <h5 class="text-center">LISTA DE CAIXAS </h5>
            </div>
            <!-- /.box-header -->
            <div class="card-body">
...
<!-- ======================== CRIANDO MODAL DE ADICIONAR BANCOS ============================-->
<?php if(in_array('modificarEmpresa', $user_permission)): ?>
...
<div class="modal fade" tabindex="-1" role="dialog" id="editModal">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form role="form" action="<?php echo base_url('bancos/update') ?>" method="post" id="updateForm">
        <div class="modal-body">
          <div id="messages"></div>
          <div class="form-group">
...
<div class="modal fade" tabindex="-1" role="dialog" id="removeModal">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form role="form" action="<?php echo base_url('bancos/remove') ?>" method="post" id="removeForm">
        <div class="modal-body">
...
$(function () {
    ...
    manageTable = $('#manageTable').DataTable({
      'ajax': base_url + 'bancos/recebeDadosBanco',
      'responsive': true,
...
{ 
  $.ajax({
    url: base_url + 'bancos/encontraBancosPorID/'+id,
    type: 'post',
    dataType: 'json',
    success:function(response) {
